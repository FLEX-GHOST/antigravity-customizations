...
[![Active Items](https://img.shields.io/badge/Indexed%20Skills%20%26%20Rules-4%2C216%2B-blue.svg)](#)
...
```
            ...
            - anti_ai_design.md                       skills-engine (28 Tools)
...
- Reduces token footprint from **40.6% (8,121 tokens)** down to **0.7% (132 tokens)** while granting instant access to 4,216+ skills.
