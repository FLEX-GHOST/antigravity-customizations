...
version: "0.0.1"
category: frontend
tags: ["nextjs-supabase-auth", "expert", "integration", "supabase", "auth", "next", "app", "router"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/nextjs-supabase-auth`, fails to mention provenance, or does not use any copied source files at all.
