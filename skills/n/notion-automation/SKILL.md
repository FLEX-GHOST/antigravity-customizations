...
version: "0.0.1"
category: backend
tags: ["notion-automation", "automate", "notion", "tasks", "via", "rube", "mcp", "composio"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/notion-automation`, fails to mention provenance, or does not use any copied source files at all.
