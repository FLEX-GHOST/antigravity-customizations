...
| Workflow execution | `references/cli-commands.md` | Starts with the smallest copied file that materially changes execution |
| Supporting context | `references/deployment-patterns.md` | Adds the next most relevant copied source file without loading the entire package |
...
**Symptoms:** The result ignores the upstream workflow in `packages/skills-catalog/skills/(cloud)/netlify-deploy`, fails to mention provenance, or does not use any copied source files at all.
...
| --- | --- | --- |
| `references` | copied reference notes, guides, or background material from upstream | `references/cli-commands.md` |
...
- [netlify-toml.md](references/netlify-toml.md)
