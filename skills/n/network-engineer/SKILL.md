...
version: "0.0.1"
category: devops
tags: ["network-engineer", "expert", "network", "engineer", "specializing", "modern", "cloud", "networking"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/network-engineer`, fails to mention provenance, or does not use any copied source files at all.
