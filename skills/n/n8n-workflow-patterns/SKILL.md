...
tags: ["n8n-workflow-patterns", "proven", "architectural", "patterns", "for", "building", "n8n", "workflows"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/n8n-workflow-patterns`, fails to mention provenance, or does not use any copied source files at all.
