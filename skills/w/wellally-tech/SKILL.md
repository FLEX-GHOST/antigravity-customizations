...
version: "0.0.1"
category: data-ai
tags: ["wellally-tech", "integrate", "multiple", "digital", "health", "data", "sources", "connect"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/wellally-tech`, fails to mention provenance, or does not use any copied source files at all.
