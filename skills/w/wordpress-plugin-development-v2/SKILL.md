---
name: wordpress-plugin-development-v2
...
tags: ["wordpress-plugin-development-v2", "wordpress-plugin-development", "wordpress", "plugin", "development", "covering", "architecture", "hooks"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/wordpress-plugin-development`, fails to mention provenance, or does not use any copied source files at all.
