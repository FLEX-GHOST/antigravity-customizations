...
tags: ["scraping", "data-extraction", "automation", "csv", "web-scraper", "web", "inteligente", "multi-estrategia"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/web-scraper`, fails to mention provenance, or does not use any copied source files at all.
