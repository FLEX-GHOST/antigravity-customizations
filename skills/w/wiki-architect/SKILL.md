...
tags: ["wiki-architect", "you", "are", "documentation", "architect", "produces", "structured", "wiki"]
complexity: beginner
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/wiki-architect`, fails to mention provenance, or does not use any copied source files at all.
