---
name: wechat-official-account-strategist-v2
description: "WeChat Official Account Strategist workflow skill. Use this skill when the user needs Grow WeChat Official Accounts (\u5fae\u4fe1\u516c\u4f17\u53f7) with high-conversion content strategy, title formulas, article architecture, and Mini-Program integration and the operator should preserve the upstream workflow, copied support files, and provenance before merging or handing off."
version: "0.0.1"
category: business
tags: ["wechat", "chinese-market", "content-strategy", "marketing", "source", "wechat-official-account-strategist-v2", "wechat-official-account-strategist", "grow"]
...
- Use when the request clearly matches the imported source intent: Grow WeChat Official Accounts (微信公众号) with high-conversion content strategy, title formulas, article architecture, and Mini-Program integration.
...
```text
Use @wechat-official-account-strategist-v2 to handle <task>. Start from the copied upstream workflow, load only the files that change the outcome, and keep provenance visible in the answer.
```
...
```text
Review @wechat-official-account-strategist-v2 against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
...
```text
Use @wechat-official-account-strategist-v2 for <task>. Load only the copied references, examples, or scripts that change the outcome, and name the files explicitly before proceeding.
```
...
```text
Review @wechat-official-account-strategist-v2 using the copied upstream files plus provenance, then summarize any gaps before merge.
```
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/wechat-official-account-strategist`, fails to mention provenance, or does not use any copied source files at all.
