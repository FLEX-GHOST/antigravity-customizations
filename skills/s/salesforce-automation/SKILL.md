...
version: "0.0.1"
category: business
tags: ["salesforce-automation", "automate", "salesforce", "tasks", "via", "rube", "mcp", "composio"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/salesforce-automation`, fails to mention provenance, or does not use any copied source files at all.
