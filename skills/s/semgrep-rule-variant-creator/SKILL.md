...
tags: ["semgrep-rule-variant-creator", "creates", "language", "variants", "existing", "semgrep", "rules", "use"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/semgrep-rule-variant-creator`, fails to mention provenance, or does not use any copied source files at all.
