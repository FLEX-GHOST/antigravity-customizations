...
version: "0.0.1"
category: business
tags: ["seo-cannibalization-detector", "analyzes", "multiple", "provided", "pages", "identify", "keyword", "overlap"]
complexity: beginner
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/seo-cannibalization-detector`, fails to mention provenance, or does not use any copied source files at all.
