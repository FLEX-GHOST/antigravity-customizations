...
tags: ["stripe-integration", "master", "stripe", "payment", "processing", "integration", "for", "robust"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/stripe-integration`, fails to mention provenance, or does not use any copied source files at all.
