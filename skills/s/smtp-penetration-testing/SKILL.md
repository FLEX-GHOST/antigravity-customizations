...
tags: ["smtp-penetration-testing", "conduct", "comprehensive", "security", "assessments", "smtp", "simple", "mail"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/smtp-penetration-testing`, fails to mention provenance, or does not use any copied source files at all.
