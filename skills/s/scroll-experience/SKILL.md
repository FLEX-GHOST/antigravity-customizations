...
version: "0.0.1"
category: frontend
tags: ["scroll-experience", "expert", "building", "immersive", "scroll-driven", "experiences", "parallax", "frontend"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/scroll-experience`, fails to mention provenance, or does not use any copied source files at all.
