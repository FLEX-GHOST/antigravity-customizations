...
tags: ["spec-to-code-compliance", "verifies", "implements", "exactly", "what", "documentation", "specifies", "for"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/spec-to-code-compliance`, fails to mention provenance, or does not use any copied source files at all.
