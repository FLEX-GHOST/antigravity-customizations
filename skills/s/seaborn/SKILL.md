...
tags: ["seaborn", "python", "visualization", "library", "for", "creating", "publication-quality", "statistical"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/seaborn`, fails to mention provenance, or does not use any copied source files at all.
