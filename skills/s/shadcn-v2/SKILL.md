...
version: "0.0.1"
category: design
tags: ["shadcn-v2", "shadcn", "manages", "components", "and", "projects", "providing", "context"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/shadcn`, fails to mention provenance, or does not use any copied source files at all.
