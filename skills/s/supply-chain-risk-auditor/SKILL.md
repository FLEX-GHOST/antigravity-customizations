...
tags: ["supply-chain-risk-auditor", "identifies", "dependencies", "heightened", "risk", "exploitation", "takeover", "use"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/supply-chain-risk-auditor`, fails to mention provenance, or does not use any copied source files at all.
