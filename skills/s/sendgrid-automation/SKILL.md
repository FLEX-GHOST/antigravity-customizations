...
tags: ["sendgrid-automation", "automate", "sendgrid", "email", "delivery", "workflows", "including", "marketing"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/sendgrid-automation`, fails to mention provenance, or does not use any copied source files at all.
