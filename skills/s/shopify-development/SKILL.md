...
version: "0.0.1"
category: backend
tags: ["shopify-development", "build", "shopify", "apps", "extensions", "themes", "using", "graphql"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/shopify-development`, fails to mention provenance, or does not use any copied source files at all.
