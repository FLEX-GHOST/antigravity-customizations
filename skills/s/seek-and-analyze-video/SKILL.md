...
version: "0.0.1"
category: data-ai
tags: ["video", "ai", "memories", "social-media", "youtube", "tiktok", "analysis", "seek-and-analyze-video"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/seek-and-analyze-video`, fails to mention provenance, or does not use any copied source files at all.
