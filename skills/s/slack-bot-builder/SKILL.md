...
version: "0.0.1"
category: frontend
tags: ["slack-bot-builder", "build", "slack", "apps", "using", "the", "bolt", "framework"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/slack-bot-builder`, fails to mention provenance, or does not use any copied source files at all.
