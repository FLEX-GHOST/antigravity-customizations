...
version: "0.0.1"
category: business
tags: ["seo-programmatic", "plan", "and", "audit", "programmatic", "seo", "pages", "generated"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/seo-programmatic`, fails to mention provenance, or does not use any copied source files at all.
