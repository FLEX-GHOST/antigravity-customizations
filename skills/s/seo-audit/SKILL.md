...
version: "0.0.1"
category: business
tags: ["seo-audit", "diagnose", "and", "audit", "seo", "issues", "affecting", "crawlability"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/seo-audit`, fails to mention provenance, or does not use any copied source files at all.
