...
version: "0.0.1"
category: frontend
tags: ["vr-ar-v2", "vr-ar", "development", "principles", "comfort", "interaction", "performance", "requirements"]
complexity: beginner
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/game-development/vr-ar`, fails to mention provenance, or does not use any copied source files at all.
