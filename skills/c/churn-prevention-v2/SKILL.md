...
version: "0.0.1"
category: business
tags: ["churn-prevention-v2", "churn-prevention", "reduce", "voluntary", "and", "involuntary", "churn", "cancel"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/churn-prevention`, fails to mention provenance, or does not use any copied source files at all.
