...
**Symptoms:** The result ignores the upstream workflow in `packages/skills-catalog/skills/(creation)/cursor-subagent-creator`, fails to mention provenance, or does not use any copied source files at all.
