...
version: "0.0.1"
category: ai-agents
tags: ["computer-use-agents", "build", "interact", "computers", "like", "humans", "ai-agents"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/computer-use-agents`, fails to mention provenance, or does not use any copied source files at all.
