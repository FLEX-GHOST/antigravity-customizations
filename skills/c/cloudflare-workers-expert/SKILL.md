...
version: "0.0.1"
category: devops
tags: ["cloudflare-workers-expert", "expert", "cloudflare", "workers", "and", "the", "edge", "computing"]
complexity: beginner
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/cloudflare-workers-expert`, fails to mention provenance, or does not use any copied source files at all.
