...
version: "0.0.1"
category: backend
tags: ["mcp", "aeo", "tool-quality", "agent-readiness", "api-scoring", "clarvia", "clarvia-aeo-check-v2", "clarvia-aeo-check"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/clarvia-aeo-check`, fails to mention provenance, or does not use any copied source files at all.
