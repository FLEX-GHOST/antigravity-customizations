---
name: computer-use-agents-v2
description: "Computer Use Agents workflow skill. Use this skill when the user needs Build AI agents that interact with computers like humans do - and the operator should preserve the upstream workflow, copied support files, and provenance before merging or handing off."
version: "0.0.1"
category: ai-agents
tags: ["computer-use-agents-v2", "computer-use-agents", "build", "interact", "computers", "like", "humans", "ai-agents"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/computer-use-agents`, fails to mention provenance, or does not use any copied source files at all.
