...
version: "0.0.1"
category: ai-agents
tags: ["context-optimization", "context", "optimization", "extends", "the", "effective", "capacity", "limited"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/context-optimization`, fails to mention provenance, or does not use any copied source files at all.
