...
version: "0.0.1"
category: backend
tags: ["cc-skill-backend-patterns", "backend", "architecture", "patterns", "api", "design", "database", "optimization"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/cc-skill-backend-patterns`, fails to mention provenance, or does not use any copied source files at all.
