...
version: "0.0.1"
category: devops
tags: ["cost-optimization-v2", "cost-optimization", "strategies", "and", "patterns", "for", "optimizing", "cloud"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/cost-optimization`, fails to mention provenance, or does not use any copied source files at all.
