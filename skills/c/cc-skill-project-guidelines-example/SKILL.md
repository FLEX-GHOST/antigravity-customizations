...
version: "0.0.1"
category: frontend
tags: ["cc-skill-project-guidelines-example", "project", "guidelines", "example", "frontend"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/cc-skill-project-guidelines-example`, fails to mention provenance, or does not use any copied source files at all.
