...
tags: ["context-driven-development", "guide", "for", "implementing", "and", "maintaining", "context", "managed"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/context-driven-development`, fails to mention provenance, or does not use any copied source files at all.
