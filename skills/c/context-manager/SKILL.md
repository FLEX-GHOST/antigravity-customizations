...
version: "0.0.1"
category: ai-agents
tags: ["context-manager", "elite", "context", "engineering", "specialist", "mastering", "dynamic", "management"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/context-manager`, fails to mention provenance, or does not use any copied source files at all.
