...
version: "0.0.1"
category: backend
tags: ["cc-skill-security-review", "ensures", "all", "follows", "security", "best", "practices", "and"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/cc-skill-security-review`, fails to mention provenance, or does not use any copied source files at all.
