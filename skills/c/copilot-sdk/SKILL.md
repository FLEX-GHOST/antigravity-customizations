...
version: "0.0.1"
category: ai-agents
tags: ["copilot-sdk", "build", "applications", "programmatically", "interact", "github", "copilot", "the"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/copilot-sdk`, fails to mention provenance, or does not use any copied source files at all.
