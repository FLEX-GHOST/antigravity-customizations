...
version: "0.0.1"
category: devops
tags: ["cirq-v2", "cirq", "google", "quantum", "open-source", "framework", "for", "designing"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/cirq`, fails to mention provenance, or does not use any copied source files at all.
