...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/chrome-extension-developer`, fails to mention provenance, or does not use any copied source files at all.
