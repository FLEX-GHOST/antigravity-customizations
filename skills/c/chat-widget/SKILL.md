...
version: "0.0.1"
category: frontend
tags: ["chat-widget", "build", "real-time", "support", "chat", "system", "floating", "widget"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/chat-widget`, fails to mention provenance, or does not use any copied source files at all.
