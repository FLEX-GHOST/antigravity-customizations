...
version: "0.0.1"
category: frontend
tags: ["codebase-to-wordpress-converter", "expert", "for", "converting", "any", "codebase", "react", "html"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/codebase-to-wordpress-converter`, fails to mention provenance, or does not use any copied source files at all.
