...
tags: ["calendly-automation", "automate", "calendly", "scheduling", "event", "management", "invitee", "tracking"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/calendly-automation`, fails to mention provenance, or does not use any copied source files at all.
