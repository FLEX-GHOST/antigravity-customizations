---
name: code-refactoring-context-restore-v2
...
tags: ["code-refactoring-context-restore-v2", "code-refactoring-context-restore", "working", "refactoring", "context", "restore", "development"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/code-refactoring-context-restore`, fails to mention provenance, or does not use any copied source files at all.
