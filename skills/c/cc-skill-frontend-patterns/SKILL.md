...
version: "0.0.1"
category: frontend
tags: ["cc-skill-frontend-patterns", "frontend", "development", "patterns", "for", "react", "next", "state"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/cc-skill-frontend-patterns`, fails to mention provenance, or does not use any copied source files at all.
