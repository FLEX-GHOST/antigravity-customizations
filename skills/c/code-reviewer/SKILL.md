...
tags: ["code-reviewer", "elite", "review", "expert", "specializing", "modern", "ai-powered", "development"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/code-reviewer`, fails to mention provenance, or does not use any copied source files at all.
