...
version: "0.0.1"
category: data-ai
tags: ["rehabilitation-analyzer", "data-ai"]
complexity: advanced
risk: safe
...
```text
Review @rehabilitation-analyzer against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
