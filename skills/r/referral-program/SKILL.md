...
version: "0.0.1"
category: tools
tags: ["referral-program", "you", "are", "expert", "viral", "growth", "and", "referral"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/referral-program`, fails to mention provenance, or does not use any copied source files at all.
