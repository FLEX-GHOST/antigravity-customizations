...
**Symptoms:** The result ignores the upstream workflow in `packages/skills-catalog/skills/(quality)/react-best-practices`, fails to mention provenance, or does not use any copied source files at all.
...
- [advanced-init-once.md](rules/advanced-init-once.md)
