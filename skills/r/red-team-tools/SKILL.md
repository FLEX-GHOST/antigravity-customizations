...
version: "0.0.1"
category: tools
tags: ["red-team-tools", "implement", "proven", "methodologies", "and", "tool", "workflows", "top"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/red-team-tools`, fails to mention provenance, or does not use any copied source files at all.
