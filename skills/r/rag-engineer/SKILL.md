...
version: "0.0.1"
category: ai-agents
tags: ["rag-engineer", "expert", "building", "retrieval-augmented", "generation", "systems", "masters", "ai-agents"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/rag-engineer`, fails to mention provenance, or does not use any copied source files at all.
