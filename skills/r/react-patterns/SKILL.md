...
tags: ["react-patterns", "modern", "react", "patterns", "and", "principles", "hooks", "composition"]
complexity: beginner
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/react-patterns`, fails to mention provenance, or does not use any copied source files at all.
