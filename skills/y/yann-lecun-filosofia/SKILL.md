...
tags: ["persona", "ai-philosophy", "open-source", "education", "yann-lecun-filosofia", "sub-skill", "filos", "fica"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/yann-lecun-filosofia`, fails to mention provenance, or does not use any copied source files at all.
