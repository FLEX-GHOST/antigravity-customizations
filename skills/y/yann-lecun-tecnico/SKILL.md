...
tags: ["persona", "cnn", "jepa", "self-supervised", "pytorch", "yann-lecun-tecnico", "sub-skill", "cnica"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/yann-lecun-tecnico`, fails to mention provenance, or does not use any copied source files at all.
