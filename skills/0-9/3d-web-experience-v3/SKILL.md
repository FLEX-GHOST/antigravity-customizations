---
name: 3d-web-experience-v3
description: "3D Web Experience workflow skill. Use this skill when the user needs Expert in building 3D experiences for the web - Three.js, React and the operator should preserve the upstream workflow, copied support files, and provenance before merging or handing off."
version: "0.0.1"
category: fullstack-web
tags: ["d-web-experience-v3", "d-web-experience", "expert", "building", "experiences", "for", "the", "web"]
complexity: advanced
risk: safe
...
```text
Use @3d-web-experience-v3 to handle <task>. Start from the copied upstream workflow, load only the files that change the outcome, and keep provenance visible in the answer.
```
...
```text
Review @3d-web-experience-v3 against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
...
```text
Use @3d-web-experience-v3 for <task>. Load only the copied references, examples, or scripts that change the outcome, and name the files explicitly before proceeding.
```
...
```text
Review @3d-web-experience-v3 using the copied upstream files plus provenance, then summarize any gaps before merge.
```
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-bundle-web-designer/skills/3d-web-experience`, fails to mention provenance, or does not use any copied source files at all.
