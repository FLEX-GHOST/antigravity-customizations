...
tags: ["d-web-experience-v2", "d-web-experience", "expert", "building", "experiences", "for", "the", "web"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/3d-web-experience`, fails to mention provenance, or does not use any copied source files at all.
