...
version: "0.0.1"
category: devops
tags: ["incident-responder-v2", "incident-responder", "expert", "sre", "incident", "responder", "specializing", "rapid"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/incident-responder`, fails to mention provenance, or does not use any copied source files at all.
