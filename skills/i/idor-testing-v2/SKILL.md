...
tags: ["idor-testing-v2", "idor-testing", "provide", "systematic", "methodologies", "for", "identifying", "and"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/idor-testing`, fails to mention provenance, or does not use any copied source files at all.
