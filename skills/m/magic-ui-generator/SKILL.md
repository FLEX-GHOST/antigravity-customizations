...
version: "0.0.1"
category: frontend
tags: ["magic-ui-generator", "utilizes", "magic", "dev", "generate", "compare", "and", "integrate"]
complexity: beginner
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/magic-ui-generator`, fails to mention provenance, or does not use any copied source files at all.
