...
version: "0.0.1"
category: product
tags: ["micro-saas-launcher", "expert", "launching", "small", "focused", "saas", "products", "fast"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/micro-saas-launcher`, fails to mention provenance, or does not use any copied source files at all.
