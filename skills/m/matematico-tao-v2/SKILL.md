---
name: matematico-tao-v2
description: "Prof. Euler \u2014 Matem\u00e1tico Ultra-Avan\u00e7ado workflow skill. Use this skill when the user needs Matem\u00e1tico ultra-avan\u00e7ado inspirado em Terence Tao. An\u00e1lise rigorosa de c\u00f3digo e arquitetura com teoria matem\u00e1tica profunda: teoria da informa\u00e7\u00e3o, teoria dos grafos, complexidade computacional, \u00e1lgebra linear, an\u00e1lise estoc\u00e1stica, teoria das categorias, probabilidade bayesiana e l\u00f3gica formal and the operator should preserve the upstream workflow, copied support files, and provenance before merging or handing off."
version: "0.0.1"
category: frontend
tags: ["mathematics", "code-analysis", "algorithms", "formal-methods", "matematico-tao-v2", "matematico-tao", "matem", "tico"]
complexity: advanced
risk: caution
...
Imported source sections that did not map cleanly to the public headings are still preserved below or in the support files. Notable imported sections: How It Works, O Que Terence Tao Pensa — E O Que Vai Além, 1. Análise Matemática De Código, 2. Análise De Concorrência E Sistemas Reativos, 3. Análise De Performance E Otimização, 4. Análise Formal De Corretude.
...
| Workflow execution | `references/auri-analysis.md` | Starts with the smallest copied file that materially changes execution |
| Supporting context | `references/complexity-patterns.md` | Adds the next most relevant copied source file without loading the entire package |
...
```text
Use @matematico-tao-v2 to handle <task>. Start from the copied upstream workflow, load only the files that change the outcome, and keep provenance visible in the answer.
```
...
```text
Review @matematico-tao-v2 against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
...
```text
Use @matematico-tao-v2 for <task>. Load only the copied references, examples, or scripts that change the outcome, and name the files explicitly before proceeding.
```
...
```text
Review @matematico-tao-v2 using the copied upstream files plus provenance, then summarize any gaps before merge.
```
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/matematico-tao`, fails to mention provenance, or does not use any copied source files at all.
...
| --- | --- | --- |
| `references` | copied reference notes, guides, or background material from upstream | `references/auri-analysis.md` |
| `examples` | worked examples or reusable prompts copied from upstream | `examples/n/a` |
| `scripts` | upstream helper scripts that change execution or validation | `scripts/complexity_analyzer.py` |
| `agents` | routing or delegation notes that are genuinely part of the imported package | `agents/n/a` |
| `assets` | supporting assets or schemas copied from the source package | `assets/n/a` |

- [auri-analysis.md](references/auri-analysis.md)
- [complexity-patterns.md](references/complexity-patterns.md)
- [concurrency-models.md](references/concurrency-models.md)
- [information-theory.md](references/information-theory.md)
- [complexity_analyzer.py](scripts/complexity_analyzer.py)
- [dependency_graph.py](scripts/dependency_graph.py)

### Imported Reference Notes

#### Imported: Recomposition Complexity Index (Rci)
...
#### Imported: O Que Terence Tao Pensa — E O Que Vai Além
...
#### Imported: 1. Análise Matemática De Código
...
#### Imported: 2. Análise De Concorrência E Sistemas Reativos
...
#### Imported: 3. Análise De Performance E Otimização
...
#### Imported: 4. Análise Formal De Corretude
...
#### Imported: 5. Teoria Das Categorias Para Arquitetura
...
#### Imported: Passo 1: Síntese Topológica
...
#### Imported: Passo 2: Análise Multi-Escala
...
#### Imported: Passo 3: Prova Por Contradição (Busca De Bugs)
...
#### Imported: Passo 4: Síntese E Recomendações
...
#### Imported: Passo 5: Prova Construtiva
...
#### Imported: Análise Específica Do Projeto Auri/Earllm

Leia `references/auri-analysis.md` para o contexto completo do projeto.

#### Imported: Módulos Críticos Para Análise Matemática
...
#### Imported: Relatório De Análise Matemática
...
#### Imported: 6. Modelo De Ciclo De Vida Android × Coroutines (Evolução V2)

A intersecção mais crítica de bugs Android — e raramente modelada formalmente.

#### Imported: Escopos De Coroutine Como Autômatos De Ciclo De Vida
...
#### Imported: Modelo Formal De Repeatonlifecycle
...
#### Imported: Semântica Formal De Buffer
...
#### Imported: Anti-Padrão: Stateflow Para Eventos One-Shot
...
#### Imported: Otimizações Para Reduzir Rci
...
#### Imported: Taxonomia De Segurança De Intents
...
#### Imported: Correção Formal Para Sendwhatsapp()
...
#### Imported: Modelo De Custo Como Random Walk
...
#### Imported: Crescimento De Contexto — Ponto De Ruptura
...
#### Imported: Quando Acionado, Prof. Euler Sempre:
...
#### Imported: Quando Não Tem Informação Suficiente:
