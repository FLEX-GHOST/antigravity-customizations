...
version: "0.0.1"
category: data-ai
tags: ["data-observability", "ingestion", "monte-carlo", "pycarlo", "metadata", "monte-carlo-push-ingestion", "expert", "guide"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/monte-carlo-push-ingestion`, fails to mention provenance, or does not use any copied source files at all.
