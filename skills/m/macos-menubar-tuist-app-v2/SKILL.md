---
name: macos-menubar-tuist-app-v2
...
tags: ["macos-menubar-tuist-app-v2", "macos-menubar-tuist-app", "build", "refactor", "review", "swiftui", "macos", "menubar"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/macos-menubar-tuist-app`, fails to mention provenance, or does not use any copied source files at all.
