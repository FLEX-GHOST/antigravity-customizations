...
version: "0.0.1"
category: design
tags: ["ui-ux-pro-max", "comprehensive", "design", "guide", "for", "web", "and", "mobile"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/ui-ux-pro-max`, fails to mention provenance, or does not use any copied source files at all.
