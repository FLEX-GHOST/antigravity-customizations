...
version: "0.0.1"
category: backend
tags: ["using-neon", "neon", "serverless", "postgres", "platform", "separates", "compute", "and"]
complexity: beginner
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/using-neon`, fails to mention provenance, or does not use any copied source files at all.
