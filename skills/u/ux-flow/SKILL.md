...
version: "0.0.1"
category: design
tags: ["ux", "flows", "navigation", "product-design", "styleseed", "ux-flow", "design", "user"]
complexity: beginner
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/ux-flow`, fails to mention provenance, or does not use any copied source files at all.
