...
| Workflow execution | `references/clean-agile.md` | Starts with the smallest copied file that materially changes execution |
| Supporting context | `references/clean-architecture.md` | Adds the next most relevant copied source file without loading the entire package |
...
```text
Use @uncle-bob-craft-v2 to handle <task>. Start from the copied upstream workflow, load only the files that change the outcome, and keep provenance visible in the answer.
```
...
```text
Review @uncle-bob-craft-v2 against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
...
```text
Use @uncle-bob-craft-v2 for <task>. Load only the copied references, examples, or scripts that change the outcome, and name the files explicitly before proceeding.
```
...
```text
Review @uncle-bob-craft-v2 using the copied upstream files plus provenance, then summarize any gaps before merge.
```
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/uncle-bob-craft`, fails to mention provenance, or does not use any copied source files at all.
...
| --- | --- | --- |
| `references` | copied reference notes, guides, or background material from upstream | `references/clean-agile.md` |
| `examples` | worked examples or reusable prompts copied from upstream | `examples/code-review-checklist.md` |
| `scripts` | upstream helper scripts that change execution or validation | `scripts/n/a` |
| `agents` | routing or delegation notes that are genuinely part of the imported package | `agents/n/a` |
| `assets` | supporting assets or schemas copied from the source package | `assets/n/a` |

- [clean-agile.md](references/clean-agile.md)
- [clean-architecture.md](references/clean-architecture.md)
- [clean-coder.md](references/clean-coder.md)
- [design-patterns.md](references/design-patterns.md)
- [code-review-checklist.md](examples/code-review-checklist.md)
- [README.md](README.md)
