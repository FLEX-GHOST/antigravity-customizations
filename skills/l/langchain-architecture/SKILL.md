...
version: "0.0.1"
category: ai-agents
tags: ["langchain-architecture", "master", "the", "langchain", "framework", "for", "building", "sophisticated"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/langchain-architecture`, fails to mention provenance, or does not use any copied source files at all.
