...
version: "0.0.1"
category: product
tags: ["logistics-exception-management", "codified", "expertise", "for", "handling", "freight", "exceptions", "shipment"]
complexity: advanced
risk: caution
...
```text
Review @logistics-exception-management against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
