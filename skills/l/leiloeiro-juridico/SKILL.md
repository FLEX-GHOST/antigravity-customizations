...
version: "0.0.1"
category: devops
tags: ["legal", "auction-law", "brazilian", "judicial", "leiloeiro-juridico", "analise", "juridica", "leiloes"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/leiloeiro-juridico`, fails to mention provenance, or does not use any copied source files at all.
