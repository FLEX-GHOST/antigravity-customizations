...
tags: ["langgraph-v2", "langgraph", "expert", "the", "production-grade", "framework", "for", "building"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/langgraph`, fails to mention provenance, or does not use any copied source files at all.
