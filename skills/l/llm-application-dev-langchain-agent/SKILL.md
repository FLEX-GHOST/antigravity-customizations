...
version: "0.0.1"
category: ai-agents
tags: ["llm-application-dev-langchain-agent", "you", "are", "expert", "langchain", "developer", "specializing", "production-grade"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/llm-application-dev-langchain-agent`, fails to mention provenance, or does not use any copied source files at all.
