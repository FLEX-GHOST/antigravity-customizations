...
version: "0.0.1"
category: business
tags: ["launch-strategy", "you", "are", "expert", "saas", "product", "launches", "and"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/launch-strategy`, fails to mention provenance, or does not use any copied source files at all.
