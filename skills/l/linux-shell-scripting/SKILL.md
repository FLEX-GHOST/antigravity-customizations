...
tags: ["linux-shell-scripting", "provide", "production-ready", "shell", "script", "templates", "for", "common"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/linux-shell-scripting`, fails to mention provenance, or does not use any copied source files at all.
