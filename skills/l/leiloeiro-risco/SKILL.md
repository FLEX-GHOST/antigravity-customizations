...
tags: ["risk-analysis", "scoring", "stress-test", "brazilian", "leiloeiro-risco", "analise", "risco", "leiloes"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/leiloeiro-risco`, fails to mention provenance, or does not use any copied source files at all.
