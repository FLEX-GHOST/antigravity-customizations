...
tags: ["laravel-expert-v2", "laravel-expert", "senior", "laravel", "engineer", "role", "for", "production-grade"]
complexity: beginner
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/laravel-expert`, fails to mention provenance, or does not use any copied source files at all.
