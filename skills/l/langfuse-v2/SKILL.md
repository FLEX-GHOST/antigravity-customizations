...
version: "0.0.1"
category: ai-agents
tags: ["langfuse-v2", "langfuse", "expert", "the", "open-source", "llm", "observability", "platform"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/langfuse`, fails to mention provenance, or does not use any copied source files at all.
