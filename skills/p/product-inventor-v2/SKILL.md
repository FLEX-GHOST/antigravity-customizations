---
name: product-inventor-v2
description: "PRODUCT INVENTOR \u2014 DESIGN ALCHEMIST v1.0 workflow skill. Use this skill when the user needs Product Inventor e Design Alchemist de nivel maximo \u2014 combina Product Thinking, Design Systems, UI Engineering, Psicologia Cognitiva, Storytelling e execucao impecavel nivel Jobs/Apple and the operator should preserve the upstream workflow, copied support files, and provenance before merging or handing off."
version: "0.0.1"
category: design
tags: ["product-thinking", "innovation", "ux-design", "storytelling", "product-inventor-v2", "product-inventor", "product", "inventor"]
complexity: advanced
risk: caution
...
Imported source sections that did not map cleanly to the public headings are still preserved below or in the support files. Notable imported sections: How It Works, Etapa A — Diagnostico Brutal, Etapa B — Conceito: A Grande Ideia, Etapa C — Blueprint De Interface, Etapa D — Implementacao (Pronto Para Producao), Etapa E — Polimento "Apple-Level".
...
- Use when the request clearly matches the imported source intent: Product Inventor e Design Alchemist de nivel maximo — combina Product Thinking, Design Systems, UI Engineering, Psicologia Cognitiva, Storytelling e execucao impecavel nivel Jobs/Apple.
...
```text
Use @product-inventor-v2 to handle <task>. Start from the copied upstream workflow, load only the files that change the outcome, and keep provenance visible in the answer.
```
...
```text
Review @product-inventor-v2 against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
...
```text
Use @product-inventor-v2 for <task>. Load only the copied references, examples, or scripts that change the outcome, and name the files explicitly before proceeding.
```
...
```text
Review @product-inventor-v2 using the copied upstream files plus provenance, then summarize any gaps before merge.
```
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/product-inventor`, fails to mention provenance, or does not use any copied source files at all.
...
#### Imported: Etapa A — Diagnostico Brutal
...
#### Imported: Etapa B — Conceito: A Grande Ideia
...
#### Imported: Etapa C — Blueprint De Interface
...
#### Imported: Etapa D — Implementacao (Pronto Para Producao)
...
#### Imported: Etapa E — Polimento "Apple-Level"
...
#### Imported: 4.2 Quando Usar Cada Abordagem
...
#### Imported: 4.3 Css Variables Como Design Tokens
...
#### Imported: Secao 5: Comandos De Ativacao
...
#### Imported: Arquitetura De Pastas
...
#### Imported: Checklist De Polimento
...
#### Imported: 7.1 O Que "Apple-Level Polish" Significa Concretamente
...
#### Imported: 7.2 Anti-Patterns Que Este Agente Nunca Produz
...
#### Imported: 7.3 Patterns Que Este Agente Sempre Produz
...
#### Imported: Secao 8: Identidades Visuais — Paletas De Referencia Proprias
...
#### Imported: Secao 9: Regras Operacionais
