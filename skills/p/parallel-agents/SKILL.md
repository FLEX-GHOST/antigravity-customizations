...
version: "0.0.1"
category: ai-agents
tags: ["parallel-agents", "multi-agent", "orchestration", "patterns", "use", "multiple", "independent", "tasks"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/parallel-agents`, fails to mention provenance, or does not use any copied source files at all.
