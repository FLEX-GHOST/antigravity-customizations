...
version: "0.0.1"
category: devops
tags: ["pricing-strategy", "design", "pricing", "packaging", "and", "monetization", "strategies", "based"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/pricing-strategy`, fails to mention provenance, or does not use any copied source files at all.
