...
tags: ["postmark-automation", "automate", "postmark", "email", "delivery", "tasks", "via", "rube"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/postmark-automation`, fails to mention provenance, or does not use any copied source files at all.
