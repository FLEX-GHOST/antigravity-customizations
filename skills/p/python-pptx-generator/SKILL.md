...
tags: ["python", "powerpoint", "python-pptx", "presentations", "slide-decks", "python-pptx-generator", "generate", "complete"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/python-pptx-generator`, fails to mention provenance, or does not use any copied source files at all.
