...
**Symptoms:** The result ignores the upstream workflow in `packages/skills-catalog/skills/(performance)/perf-web-optimization`, fails to mention provenance, or does not use any copied source files at all.
...
- [bundle-optimization.md](references/bundle-optimization.md)
- [core-web-vitals.md](references/core-web-vitals.md)
- [image-optimization.md](references/image-optimization.md)
- [bundle-optimization.md](references/bundle-optimization.md)
- [core-web-vitals.md](references/core-web-vitals.md)
- [image-optimization.md](references/image-optimization.md)
