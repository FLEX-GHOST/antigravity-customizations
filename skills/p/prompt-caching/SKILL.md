...
version: "0.0.1"
category: ai-agents
tags: ["prompt-caching", "caching", "strategies", "for", "llm", "prompts", "including", "anthropic"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/prompt-caching`, fails to mention provenance, or does not use any copied source files at all.
