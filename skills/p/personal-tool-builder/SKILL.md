...
version: "0.0.1"
category: tools
tags: ["personal-tool-builder", "expert", "building", "custom", "tools", "solve", "your", "own"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/personal-tool-builder`, fails to mention provenance, or does not use any copied source files at all.
