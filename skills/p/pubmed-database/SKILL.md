...
version: "0.0.1"
category: backend
tags: ["pubmed-database", "direct", "rest", "api", "access", "pubmed", "advanced", "boolean"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/pubmed-database`, fails to mention provenance, or does not use any copied source files at all.
