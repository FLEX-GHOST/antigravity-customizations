...
version: "0.0.1"
category: backend
tags: ["postgresql-optimization", "postgresql", "database", "optimization", "for", "query", "tuning", "indexing"]
complexity: beginner
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/postgresql-optimization`, fails to mention provenance, or does not use any copied source files at all.
