...
version: "0.0.1"
category: backend
tags: ["plaid-fintech", "expert", "patterns", "for", "plaid", "api", "integration", "including"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/plaid-fintech`, fails to mention provenance, or does not use any copied source files at all.
