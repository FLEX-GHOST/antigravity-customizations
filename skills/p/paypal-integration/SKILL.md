...
tags: ["paypal-integration", "master", "paypal", "payment", "integration", "including", "express", "checkout"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/paypal-integration`, fails to mention provenance, or does not use any copied source files at all.
