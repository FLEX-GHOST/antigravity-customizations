...
description: "GROWTH-ENGINE -- Crescimento Exponencial workflow skill. Use this skill when the user needs Motor de crescimento para produtos digitais -- growth hacking, SEO, ASO, viral loops, email marketing, CRM, referral programs e aquisicao organica and the operator should preserve the upstream workflow, copied support files, and provenance before merging or handing off."
version: "0.0.1"
category: business
tags: ["growth", "seo", "marketing", "viral", "acquisition", "growth-engine-v2", "growth-engine", "motor"]
complexity: advanced
risk: caution
...
Imported source sections that did not map cleanly to the public headings are still preserved below or in the support files. Notable imported sections: How It Works, Pirate Metrics (Aarrr) Para Auri, Checklist Seo Para Landing Page Auri, Keywords Estrategicas Auri, Amazon Skill Store Optimization, Tipos De Viral Loops Para Auri.
...
- Use when the request clearly matches the imported source intent: Motor de crescimento para produtos digitais -- growth hacking, SEO, ASO, viral loops, email marketing, CRM, referral programs e aquisicao organica.
...
```text
Use @growth-engine-v2 to handle <task>. Start from the copied upstream workflow, load only the files that change the outcome, and keep provenance visible in the answer.
```
...
```text
Review @growth-engine-v2 against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
...
```text
Use @growth-engine-v2 for <task>. Load only the copied references, examples, or scripts that change the outcome, and name the files explicitly before proceeding.
```
...
```text
Review @growth-engine-v2 using the copied upstream files plus provenance, then summarize any gaps before merge.
```
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/growth-engine`, fails to mention provenance, or does not use any copied source files at all.
...
#### Imported: Pirate Metrics (Aarrr) Para Auri
...
#### Imported: Checklist Seo Para Landing Page Auri
...
#### Imported: Keywords Estrategicas Auri
...
#### Imported: Amazon Skill Store Optimization
...
#### Imported: Tipos De Viral Loops Para Auri
...
#### Imported: Calculadora De Viral Coefficient
...
#### Imported: Sequencia De Onboarding (7 Dias)
...
#### Imported: Estrategia De Lancamento
