...
tags: ["googlesheets-automation", "automate", "google", "sheets", "operations", "read", "write", "format"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/googlesheets-automation`, fails to mention provenance, or does not use any copied source files at all.
