...
version: "0.0.1"
category: frontend
tags: ["frontend", "design", "gsap", "motion", "gpt-taste", "generating", "elite", "gsap-heavy"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/gpt-taste`, fails to mention provenance, or does not use any copied source files at all.
