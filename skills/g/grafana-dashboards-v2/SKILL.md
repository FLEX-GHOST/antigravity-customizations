...
version: "0.0.1"
category: product
tags: ["grafana-dashboards-v2", "grafana-dashboards", "create", "and", "manage", "production-ready", "grafana", "dashboards"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/grafana-dashboards`, fails to mention provenance, or does not use any copied source files at all.
