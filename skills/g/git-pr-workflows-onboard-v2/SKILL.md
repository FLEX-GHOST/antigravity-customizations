...
version: "0.0.1"
category: devops
tags: ["git-pr-workflows-onboard-v2", "git-pr-workflows-onboard", "you", "are", "expert", "onboarding", "specialist", "and"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/git-pr-workflows-onboard`, fails to mention provenance, or does not use any copied source files at all.
