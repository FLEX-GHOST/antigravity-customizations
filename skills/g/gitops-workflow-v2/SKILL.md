...
version: "0.0.1"
category: devops
tags: ["gitops-workflow-v2", "gitops-workflow", "complete", "guide", "implementing", "gitops", "workflows", "argocd"]
...
<!-- security-allowlist: curl-pipe-bash --> # GitOps Workflow Complete guide to implementing GitOps workflows with ArgoCD and Flux for automated Kubernetes deployments.
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/gitops-workflow`, fails to mention provenance, or does not use any copied source files at all.
