...
version: "0.0.1"
category: backend
tags: ["gemini-api-dev-v2", "gemini-api-dev", "the", "gemini", "api", "provides", "access", "google"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/gemini-api-dev`, fails to mention provenance, or does not use any copied source files at all.
