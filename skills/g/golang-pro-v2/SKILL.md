...
version: "0.0.1"
category: backend
tags: ["golang-pro-v2", "golang-pro", "master", "modern", "patterns", "advanced", "concurrency", "performance"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/golang-pro`, fails to mention provenance, or does not use any copied source files at all.
