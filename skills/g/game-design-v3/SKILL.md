...
version: "0.0.1"
category: design
tags: ["game-design-v3", "game-design", "game", "design", "principles", "gdd", "structure", "balancing"]
complexity: beginner
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-bundle-indie-game-dev/skills/game-development/game-design`, fails to mention provenance, or does not use any copied source files at all.
