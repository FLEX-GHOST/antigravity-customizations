...
version: "0.0.1"
category: frontend
tags: ["defi-protocol-templates", "implement", "defi", "protocols", "production-ready", "templates", "for", "staking"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/defi-protocol-templates`, fails to mention provenance, or does not use any copied source files at all.
