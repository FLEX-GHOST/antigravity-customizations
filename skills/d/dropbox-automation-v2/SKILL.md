...
tags: ["dropbox-automation-v2", "dropbox-automation", "automate", "dropbox", "file", "management", "sharing", "search"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/dropbox-automation`, fails to mention provenance, or does not use any copied source files at all.
