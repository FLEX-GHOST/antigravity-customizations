...
version: "0.0.1"
category: backend
tags: ["database-optimizer-v2", "database-optimizer", "expert", "database", "optimizer", "specializing", "modern", "performance"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/database-optimizer`, fails to mention provenance, or does not use any copied source files at all.
