...
tags: ["doc-coauthoring", "provides", "structured", "for", "guiding", "users", "collaborative", "document"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/doc-coauthoring`, fails to mention provenance, or does not use any copied source files at all.
