...
version: "0.0.1"
category: tools
tags: ["devcontainer-setup-v2", "devcontainer-setup", "creates", "devcontainers", "claude", "language-specific", "tooling", "python"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/devcontainer-setup`, fails to mention provenance, or does not use any copied source files at all.
