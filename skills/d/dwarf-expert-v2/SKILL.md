...
tags: ["dwarf-expert-v2", "dwarf-expert", "provides", "expertise", "for", "analyzing", "dwarf", "debug"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/dwarf-expert`, fails to mention provenance, or does not use any copied source files at all.
