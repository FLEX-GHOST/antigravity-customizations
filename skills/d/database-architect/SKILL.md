...
version: "0.0.1"
category: backend
tags: ["database-architect", "expert", "database", "architect", "specializing", "data", "layer", "design"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/database-architect`, fails to mention provenance, or does not use any copied source files at all.
