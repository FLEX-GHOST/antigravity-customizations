...
version: "0.0.1"
category: devops
tags: ["dotnet-architect-v2", "dotnet-architect", "expert", "net", "backend", "architect", "specializing", "asp"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/dotnet-architect`, fails to mention provenance, or does not use any copied source files at all.
