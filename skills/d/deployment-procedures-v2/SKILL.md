...
version: "0.0.1"
category: devops
tags: ["deployment-procedures-v2", "deployment-procedures", "production", "deployment", "principles", "and", "decision-making", "safe"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/deployment-procedures`, fails to mention provenance, or does not use any copied source files at all.
