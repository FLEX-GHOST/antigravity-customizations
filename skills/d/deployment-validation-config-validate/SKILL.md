...
```text
Review @deployment-validation-config-validate against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
