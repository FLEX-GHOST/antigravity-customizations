...
version: "0.0.1"
category: devops
tags: ["devops-troubleshooter", "expert", "devops", "troubleshooter", "specializing", "rapid", "incident", "response"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/devops-troubleshooter`, fails to mention provenance, or does not use any copied source files at all.
