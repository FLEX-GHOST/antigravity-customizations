...
description: "Django Access Control & IDOR Review workflow skill. Use this skill when the user needs django-access-review and the operator should preserve the upstream workflow, copied support files, and provenance before merging or handing off."
version: "0.0.1"
category: backend
tags: ["django-access-review", "backend"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/django-access-review`, fails to mention provenance, or does not use any copied source files at all.
