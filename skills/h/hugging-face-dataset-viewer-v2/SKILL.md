---
name: hugging-face-dataset-viewer-v2
...
version: "0.0.1"
category: data-ai
tags: ["hugging-face-dataset-viewer-v2", "hugging-face-dataset-viewer", "query", "hugging", "face", "datasets", "the", "dataset"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/hugging-face-dataset-viewer`, fails to mention provenance, or does not use any copied source files at all.
