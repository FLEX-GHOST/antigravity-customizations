---
name: html-injection-testing-v2
...
tags: ["html-injection-testing-v2", "html-injection-testing", "identify", "and", "exploit", "html", "injection", "vulnerabilities"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/html-injection-testing`, fails to mention provenance, or does not use any copied source files at all.
