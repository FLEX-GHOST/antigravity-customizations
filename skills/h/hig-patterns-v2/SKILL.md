...
version: "0.0.1"
category: frontend
tags: ["hig-patterns-v2", "hig-patterns", "apple", "human", "interface", "guidelines", "interaction", "and"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/hig-patterns`, fails to mention provenance, or does not use any copied source files at all.
