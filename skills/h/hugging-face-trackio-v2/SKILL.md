...
tags: ["hugging-face-trackio-v2", "hugging-face-trackio", "track", "experiments", "trackio", "using", "python", "logging"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/hugging-face-trackio`, fails to mention provenance, or does not use any copied source files at all.
