...
version: "0.0.1"
category: frontend
tags: ["health-trend-analyzer", "bmi", "html", "echarts", "frontend"]
...
```text
Review @health-trend-analyzer against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
