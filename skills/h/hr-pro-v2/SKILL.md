...
version: "0.0.1"
category: devops
tags: ["hr-pro-v2", "hr-pro", "professional", "ethical", "partner", "for", "hiring", "onboarding"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/hr-pro`, fails to mention provenance, or does not use any copied source files at all.
