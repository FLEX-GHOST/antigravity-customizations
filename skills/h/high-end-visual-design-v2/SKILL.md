---
name: high-end-visual-design-v2
description: "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier) workflow skill. Use this skill when the user needs designing expensive agency-grade interfaces with premium fonts, spatial rhythm, soft depth, and fluid microinteractions and the operator should preserve the upstream workflow, copied support files, and provenance before merging or handing off."
version: "0.0.1"
category: frontend
tags: ["frontend", "visual-design", "motion", "ui", "high-end-visual-design-v2", "high-end-visual-design", "designing", "expensive"]
complexity: advanced
risk: caution
...
```text
Use @high-end-visual-design-v2 to handle <task>. Start from the copied upstream workflow, load only the files that change the outcome, and keep provenance visible in the answer.
```
...
```text
Review @high-end-visual-design-v2 against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
...
```text
Use @high-end-visual-design-v2 for <task>. Load only the copied references, examples, or scripts that change the outcome, and name the files explicitly before proceeding.
```
...
```text
Review @high-end-visual-design-v2 using the copied upstream files plus provenance, then summarize any gaps before merge.
```
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/high-end-visual-design`, fails to mention provenance, or does not use any copied source files at all.
