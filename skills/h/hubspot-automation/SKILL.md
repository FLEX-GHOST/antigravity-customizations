...
tags: ["hubspot-automation", "automate", "hubspot", "crm", "operations", "contacts", "companies", "deals"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/hubspot-automation`, fails to mention provenance, or does not use any copied source files at all.
