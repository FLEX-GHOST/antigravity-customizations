...
version: "0.0.1"
category: ai-agents
tags: ["headline-psychologist", "one", "sentence", "what", "does", "and", "invoke", "ai-agents"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/headline-psychologist`, fails to mention provenance, or does not use any copied source files at all.
