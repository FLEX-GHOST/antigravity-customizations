...
tags: ["faf", "automation", "project-setup", "ai-context", "productivity", "faf-wizard", "done-for-you", "generator"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/faf-wizard`, fails to mention provenance, or does not use any copied source files at all.
