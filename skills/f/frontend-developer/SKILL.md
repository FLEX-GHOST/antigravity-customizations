...
version: "0.0.1"
category: frontend
tags: ["frontend-developer", "build", "react", "components", "implement", "responsive", "layouts", "and"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/frontend-developer`, fails to mention provenance, or does not use any copied source files at all.
