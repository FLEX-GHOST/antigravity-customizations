...
```text
Use @frontend-blueprint to handle <task>. Start from the copied upstream workflow, load only the files that change the outcome, and keep provenance visible in the answer.
```
...
```text
Use @frontend-blueprint for <task>. Load only the copied references, examples, or scripts that change the outcome, and name the files explicitly before proceeding.
```
...
```text
Review @frontend-blueprint using the copied upstream files plus provenance, then summarize any gaps before merge.
```
...
| --- | --- | --- |
| `references` | copied reference notes, guides, or background material from upstream | `references/collection-guide.md` |
| `examples` | worked examples or reusable prompts copied from upstream | `examples/n/a` |
| `scripts` | upstream helper scripts that change execution or validation | `scripts/n/a` |
| `agents` | routing or delegation notes that are genuinely part of the imported package | `agents/n/a` |
| `assets` | supporting assets or schemas copied from the source package | `assets/n/a` |

- [collection-guide.md](references/collection-guide.md)
- [design-principles.md](references/design-principles.md)
- [stitch-integration.md](references/stitch-integration.md)
- [collection-guide.md](references/collection-guide.md)
- [design-principles.md](references/design-principles.md)
- [stitch-integration.md](references/stitch-integration.md)
