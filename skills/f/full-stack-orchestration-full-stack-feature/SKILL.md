...
version: "0.0.1"
category: product
tags: ["full-stack-orchestration-full-stack-feature", "working", "full", "stack", "orchestration", "feature", "product"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/full-stack-orchestration-full-stack-feature`, fails to mention provenance, or does not use any copied source files at all.
