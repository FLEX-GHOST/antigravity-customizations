...
```text
Review @full-stack-orchestration-full-stack-feature-v2 against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
