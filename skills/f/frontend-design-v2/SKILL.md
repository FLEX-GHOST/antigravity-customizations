...
version: "0.0.1"
category: frontend
tags: ["frontend-design-v2", "frontend-design", "you", "are", "frontend", "designer-engineer", "not", "layout"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/frontend-design`, fails to mention provenance, or does not use any copied source files at all.
