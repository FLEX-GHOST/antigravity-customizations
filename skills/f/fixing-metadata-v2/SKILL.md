...
version: "0.0.1"
category: frontend
tags: ["fixing-metadata-v2", "fixing-metadata", "audit", "and", "fix", "html", "metadata", "including"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/fixing-metadata`, fails to mention provenance, or does not use any copied source files at all.
