---
name: framework-migration-deps-upgrade-v2
...
tags: ["framework-migration-deps-upgrade-v2", "framework-migration-deps-upgrade", "you", "are", "dependency", "management", "expert", "specializing"]
complexity: beginner
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/framework-migration-deps-upgrade`, fails to mention provenance, or does not use any copied source files at all.
