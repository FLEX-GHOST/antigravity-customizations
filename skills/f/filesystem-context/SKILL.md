...
version: "0.0.1"
category: ai-agents
tags: ["filesystem-context", "use", "for", "file-based", "context", "management", "dynamic", "discovery"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/filesystem-context`, fails to mention provenance, or does not use any copied source files at all.
