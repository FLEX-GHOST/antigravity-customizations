...
version: "0.0.1"
category: data-ai
tags: ["fitness-analyzer-v2", "fitness-analyzer", "data-ai"]
...
```text
Review @fitness-analyzer-v2 against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
