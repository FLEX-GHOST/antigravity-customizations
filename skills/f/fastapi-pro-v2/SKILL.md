...
version: "0.0.1"
category: backend
tags: ["fastapi-pro-v2", "fastapi-pro", "build", "high-performance", "async", "apis", "fastapi", "sqlalchemy"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/fastapi-pro`, fails to mention provenance, or does not use any copied source files at all.
