...
version: "0.0.1"
category: frontend
tags: ["output", "code-generation", "quality", "full-output-enforcement", "task", "requires", "exhaustive", "unabridged"]
complexity: beginner
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/full-output-enforcement`, fails to mention provenance, or does not use any copied source files at all.
