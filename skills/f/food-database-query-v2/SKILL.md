...
version: "0.0.1"
category: backend
tags: ["food-database-query-v2", "food-database-query", "food", "database", "query", "backend"]
complexity: advanced
risk: safe
...
```text
Review @food-database-query-v2 against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
