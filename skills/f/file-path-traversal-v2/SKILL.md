...
tags: ["file-path-traversal-v2", "file-path-traversal", "identify", "and", "exploit", "file", "path", "traversal"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/file-path-traversal`, fails to mention provenance, or does not use any copied source files at all.
