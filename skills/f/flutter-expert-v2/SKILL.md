...
tags: ["flutter-expert-v2", "flutter-expert", "master", "flutter", "development", "dart", "advanced", "widgets"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/flutter-expert`, fails to mention provenance, or does not use any copied source files at all.
