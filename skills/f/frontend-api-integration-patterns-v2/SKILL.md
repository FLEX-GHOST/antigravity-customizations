...
version: "0.0.1"
category: frontend
tags: ["frontend", "api-integration", "javascript", "react", "async", "frontend-api-integration-patterns-v2", "frontend-api-integration-patterns", "production-ready"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/frontend-api-integration-patterns`, fails to mention provenance, or does not use any copied source files at all.
