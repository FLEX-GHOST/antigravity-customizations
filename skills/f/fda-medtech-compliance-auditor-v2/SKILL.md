---
name: fda-medtech-compliance-auditor-v2
...
```text
Review @fda-medtech-compliance-auditor-v2 against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
