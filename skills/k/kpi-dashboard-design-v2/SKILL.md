...
version: "0.0.1"
category: design
tags: ["kpi-dashboard-design-v2", "kpi-dashboard-design", "comprehensive", "patterns", "for", "designing", "effective", "key"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/kpi-dashboard-design`, fails to mention provenance, or does not use any copied source files at all.
