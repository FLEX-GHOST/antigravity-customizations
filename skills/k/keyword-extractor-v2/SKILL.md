...
tags: ["keyword-extractor-v2", "keyword-extractor", "machine-learning"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/keyword-extractor`, fails to mention provenance, or does not use any copied source files at all.
