...
tags: ["k8s-security-policies-v2", "k8s-security-policies", "comprehensive", "guide", "for", "implementing", "networkpolicy", "podsecuritypolicy"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/k8s-security-policies`, fails to mention provenance, or does not use any copied source files at all.
