...
version: "0.0.1"
category: devops
tags: ["kubernetes-architect-v2", "kubernetes-architect", "expert", "kubernetes", "architect", "specializing", "cloud-native", "infrastructure"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/kubernetes-architect`, fails to mention provenance, or does not use any copied source files at all.
