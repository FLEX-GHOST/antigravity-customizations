...
version: "0.0.1"
category: tools
tags: ["azure-identity-dotnet", "azure", "identity", "sdk", "for", "net", "authentication", "library"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/azure-identity-dotnet`, fails to mention provenance, or does not use any copied source files at all.
