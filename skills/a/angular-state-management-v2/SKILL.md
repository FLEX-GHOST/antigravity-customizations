---
name: angular-state-management-v2
...
version: "0.0.1"
category: frontend
tags: ["angular-state-management-v2", "angular-state-management", "master", "modern", "angular", "state", "management", "signals"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/angular-state-management`, fails to mention provenance, or does not use any copied source files at all.
