...
version: "0.0.1"
category: backend
tags: ["azure-monitor-opentelemetry-ts", "auto-instrument", "node", "applications", "distributed", "tracing", "metrics", "and"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/azure-monitor-opentelemetry-ts`, fails to mention provenance, or does not use any copied source files at all.
