...
version: "0.0.1"
category: backend
tags: ["appdeploy", "deploy", "web", "apps", "backend", "apis", "database", "and"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/appdeploy`, fails to mention provenance, or does not use any copied source files at all.
