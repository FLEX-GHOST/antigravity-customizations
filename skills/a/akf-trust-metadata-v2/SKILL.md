...
tags: ["trust", "metadata", "provenance", "compliance", "file-format", "ai-native", "akf-trust-metadata-v2", "akf-trust-metadata"]
complexity: beginner
risk: safe
...
```text
Review @akf-trust-metadata-v2 against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
