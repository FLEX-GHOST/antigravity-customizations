...
tags: ["azure-communication-chat-java", "build", "real-time", "chat", "applications", "thread", "management", "messaging"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/azure-communication-chat-java`, fails to mention provenance, or does not use any copied source files at all.
