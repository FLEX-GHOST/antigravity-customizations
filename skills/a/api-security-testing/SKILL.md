...
tags: ["api-security-testing", "api", "security", "testing", "for", "rest", "and", "graphql"]
complexity: beginner
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/api-security-testing`, fails to mention provenance, or does not use any copied source files at all.
