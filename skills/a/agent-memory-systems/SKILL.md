...
description: "Agent Memory Systems workflow skill. Use this skill when the user needs \"Memory is the cornerstone of intelligent agents. Without it, every and the operator should preserve the upstream workflow, copied support files, and provenance before merging or handing off."
version: "0.0.1"
category: ai-agents
tags: ["agent-memory-systems", "memory", "the", "cornerstone", "intelligent", "without", "every", "ai-agents"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/agent-memory-systems`, fails to mention provenance, or does not use any copied source files at all.
...
#### Imported: Hierarchical Chunking
...
#### Imported: Size recommendations by content type
...
#### Imported: Use overlap to prevent boundary issues
...
#### Imported: Always filter by metadata first
...
#### Imported: Use hybrid search (semantic + keyword)
...
#### Imported: Rerank results with cross-encoder
...
#### Imported: Explicit versioning for facts
...
#### Imported: Detect conflicts on storage
...
#### Imported: Conflict detection heuristic
...
#### Imported: Periodic consolidation
...
#### Imported: Budget tokens for different memory types
...
#### Imported: Dynamic k based on chunk size
...
#### Imported: Track embedding model in metadata
...
#### Imported: Filter by model version on retrieval
...
#### Imported: Migration strategy for model upgrades
...
#### Imported: Use separate collections during migration
