...
version: "0.0.1"
category: ai-agents
tags: ["azure-ai-agents-persistent-dotnet", "azure", "persistent", "sdk", "for", "net", "low-level", "creating"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/azure-ai-agents-persistent-dotnet`, fails to mention provenance, or does not use any copied source files at all.
