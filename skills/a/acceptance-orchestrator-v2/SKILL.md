---
name: acceptance-orchestrator-v2
...
tags: ["acceptance-orchestrator-v2", "acceptance-orchestrator", "coding", "task", "should", "driven", "end-to-end", "issue"]
complexity: beginner
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/acceptance-orchestrator`, fails to mention provenance, or does not use any copied source files at all.
