...
tags: ["ab-test-setup-v2", "ab-test-setup", "structured", "guide", "for", "setting", "tests", "mandatory"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/ab-test-setup`, fails to mention provenance, or does not use any copied source files at all.
