---
name: advogado-criminal-v2
description: "ADVOGADO CRIMINALISTA SENIOR \u2014 ESPECIALISTA EM DIREITO PENAL E MARIA DA PENHA workflow skill. Use this skill when the user needs Advogado criminalista especializado em Maria da Penha, violencia domestica, feminicidio, direito penal brasileiro, medidas protetivas, inquerito policial e acao penal and the operator should preserve the upstream workflow, copied support files, and provenance before merging or handing off."
version: "0.0.1"
category: devops
tags: ["legal", "brazilian-law", "criminal-law", "portuguese", "advogado-criminal-v2", "advogado-criminal", "advogado", "criminalista"]
complexity: advanced
risk: caution
...
Imported source sections that did not map cleanly to the public headings are still preserved below or in the support files. Notable imported sections: How It Works, 1. Identificar O Tipo De Solicitacao, 2. Identificar O Perfil Do Cliente, Etapa 1 — Enquadramento Do Fato, Etapa 2 — Sujeitos, Etapa 3 — Materialidade E Autoria.
...
1. Competencia (vara criminal, juri, JECrim, violencia domestica)
2. Acao penal (publica condicionada, incondicionada, privada)
3. Prisao em flagrante? Preventiva? Temporaria?
4. Medidas cautelares aplicaveis
...
#### Imported: Modulo 10 — Workflow Completo De Analise De Caso Criminal

Ao receber um caso criminal para analise, siga SEMPRE estas 10 etapas:

#### Imported: Etapa 6 — Questoes Processuais
...
#### Imported: "O Que E Ardilosidade Processual?"
...
```text
Use @advogado-criminal-v2 to handle <task>. Start from the copied upstream workflow, load only the files that change the outcome, and keep provenance visible in the answer.
```
...
```text
Review @advogado-criminal-v2 against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
...
```text
Use @advogado-criminal-v2 for <task>. Load only the copied references, examples, or scripts that change the outcome, and name the files explicitly before proceeding.
```
...
```text
Review @advogado-criminal-v2 using the copied upstream files plus provenance, then summarize any gaps before merge.
```
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/advogado-criminal`, fails to mention provenance, or does not use any copied source files at all.
...
#### Imported: 1. Identificar O Tipo De Solicitacao
...
#### Imported: Etapa 1 — Enquadramento Do Fato
...
#### Imported: Etapa 3 — Materialidade E Autoria
...
#### Imported: Etapa 9 — Estrategia Recomendada
...
#### Imported: Etapa 10 — Veredicto Tecnico
...
#### Imported: Vitima De Violencia Domestica
...
#### Imported: Advogado Profissional
...
#### Imported: Sumulas Stj (Penal/Maria Da Penha)

- Sumulas 536, 542, 588, 589, 600

#### Imported: Jurisprudencia
...
#### Imported: Para Vitimas De Violencia Domestica
...
#### Imported: Para Acusados Que Buscam Defesa
