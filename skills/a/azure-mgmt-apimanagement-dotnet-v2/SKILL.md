---
name: azure-mgmt-apimanagement-dotnet-v2
...
version: "0.0.1"
category: backend
tags: ["azure-mgmt-apimanagement-dotnet-v2", "azure-mgmt-apimanagement-dotnet", "azure", "resource", "manager", "sdk", "for", "api"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/azure-mgmt-apimanagement-dotnet`, fails to mention provenance, or does not use any copied source files at all.
