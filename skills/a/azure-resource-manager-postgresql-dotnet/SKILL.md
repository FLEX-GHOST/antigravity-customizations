...
version: "0.0.1"
category: backend
tags: ["azure-resource-manager-postgresql-dotnet", "azure", "postgresql", "flexible", "server", "sdk", "for", "net"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/azure-resource-manager-postgresql-dotnet`, fails to mention provenance, or does not use any copied source files at all.
