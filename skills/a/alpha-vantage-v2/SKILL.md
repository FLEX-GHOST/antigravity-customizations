...
version: "0.0.1"
category: data-ai
tags: ["alpha-vantage-v2", "alpha-vantage", "access", "years", "global", "financial", "data", "equities"]
...
```text
Review @alpha-vantage-v2 against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
