---
name: azure-eventgrid-dotnet-v2
...
tags: ["azure-eventgrid-dotnet-v2", "azure-eventgrid-dotnet", "azure", "event", "grid", "sdk", "for", "net"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/azure-eventgrid-dotnet`, fails to mention provenance, or does not use any copied source files at all.
