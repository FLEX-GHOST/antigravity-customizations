...
version: "0.0.1"
category: ai-agents
tags: ["agent-evaluation-v2", "agent-evaluation", "testing", "and", "benchmarking", "llm", "including", "behavioral"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/agent-evaluation`, fails to mention provenance, or does not use any copied source files at all.
