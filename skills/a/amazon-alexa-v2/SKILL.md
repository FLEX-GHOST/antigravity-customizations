...
version: "0.0.1"
category: devops
tags: ["voice", "alexa", "aws", "smart-home", "iot", "amazon-alexa-v2", "amazon-alexa", "integracao"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/amazon-alexa`, fails to mention provenance, or does not use any copied source files at all.
