---
name: azure-messaging-webpubsubservice-py-v2
...
tags: ["azure-messaging-webpubsubservice-py-v2", "azure-messaging-webpubsubservice-py", "azure", "web", "pubsub", "service", "sdk", "for"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/azure-messaging-webpubsubservice-py`, fails to mention provenance, or does not use any copied source files at all.
