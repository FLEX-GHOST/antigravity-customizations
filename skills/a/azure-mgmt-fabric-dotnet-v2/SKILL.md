---
name: azure-mgmt-fabric-dotnet-v2
...
tags: ["azure-mgmt-fabric-dotnet-v2", "azure-mgmt-fabric-dotnet", "azure", "resource", "manager", "sdk", "for", "fabric"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/azure-mgmt-fabric-dotnet`, fails to mention provenance, or does not use any copied source files at all.
