---
name: apify-competitor-intelligence-v2
description: "Competitor Intelligence workflow skill. Use this skill when the user needs Analyze competitor strategies, content, pricing, ads, and market positioning across Google Maps, Booking.com, Facebook, Instagram, YouTube, and TikTok and the operator should preserve the upstream workflow, copied support files, and provenance before merging or handing off."
version: "0.0.1"
category: backend
tags: ["apify-competitor-intelligence-v2", "apify-competitor-intelligence", "analyze", "competitor", "strategies", "content", "pricing", "ads"]
...
# Competitor Intelligence Analyze competitors using Apify Actors to extract data from multiple platforms.
...
- Use when the request clearly matches the imported source intent: Analyze competitor strategies, content, pricing, ads, and market positioning across Google Maps, Booking.com, Facebook, Instagram, YouTube, and TikTok.
...
1. [ ] Step 1: Identify competitor analysis type (select Actor)
...
7. Competitor business data - compass/crawler-google-places - Location analysis
...
```text
Use @apify-competitor-intelligence-v2 to handle <task>. Start from the copied upstream workflow, load only the files that change the outcome, and keep provenance visible in the answer.
```
...
```text
Review @apify-competitor-intelligence-v2 against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
...
```text
Use @apify-competitor-intelligence-v2 for <task>. Load only the copied references, examples, or scripts that change the outcome, and name the files explicitly before proceeding.
```
...
```text
Review @apify-competitor-intelligence-v2 using the copied upstream files plus provenance, then summarize any gaps before merge.
```
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/apify-competitor-intelligence`, fails to mention provenance, or does not use any copied source files at all.
