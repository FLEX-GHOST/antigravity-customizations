...
version: "0.0.1"
category: ai-agents
tags: ["agents-v2-py-v2", "agents-v2-py", "build", "container-based", "foundry", "azure", "projects", "sdk"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/agents-v2-py`, fails to mention provenance, or does not use any copied source files at all.
