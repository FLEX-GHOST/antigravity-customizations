...
version: "0.0.1"
category: product
tags: ["ai-wrapper-product", "expert", "building", "products", "wrap", "apis", "openai", "anthropic"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/ai-wrapper-product`, fails to mention provenance, or does not use any copied source files at all.
