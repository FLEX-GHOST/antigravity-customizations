...
version: "0.0.1"
category: backend
tags: ["azure-search-documents-py", "azure", "search", "sdk", "for", "python", "use", "vector"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/azure-search-documents-py`, fails to mention provenance, or does not use any copied source files at all.
