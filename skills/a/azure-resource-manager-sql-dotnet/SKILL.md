...
version: "0.0.1"
category: backend
tags: ["azure-resource-manager-sql-dotnet", "azure", "resource", "manager", "sdk", "for", "sql", "net"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/azure-resource-manager-sql-dotnet`, fails to mention provenance, or does not use any copied source files at all.
