...
tags: ["airtable-automation-v2", "airtable-automation", "automate", "airtable", "tasks", "via", "rube", "mcp"]
...
```text
Review @airtable-automation-v2 against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
