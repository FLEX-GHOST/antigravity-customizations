...
version: "0.0.1"
category: backend
tags: ["azure-cosmos-db-py-v2", "azure-cosmos-db-py", "build", "production-grade", "azure", "cosmos", "nosql", "services"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/azure-cosmos-db-py`, fails to mention provenance, or does not use any copied source files at all.
