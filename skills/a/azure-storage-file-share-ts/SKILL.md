...
version: "0.0.1"
category: ai-agents
tags: ["azure-storage-file-share-ts", "azure", "file", "share", "javascript", "typescript", "sdk", "storage-file-share"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/azure-storage-file-share-ts`, fails to mention provenance, or does not use any copied source files at all.
