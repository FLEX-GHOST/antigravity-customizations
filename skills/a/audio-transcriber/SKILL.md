...
tags: ["audio", "transcription", "whisper", "meeting-minutes", "speech-to-text", "audio-transcriber", "transform", "recordings"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/audio-transcriber`, fails to mention provenance, or does not use any copied source files at all.
