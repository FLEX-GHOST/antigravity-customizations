---
name: azure-maps-search-dotnet-v2
...
tags: ["azure-maps-search-dotnet-v2", "azure-maps-search-dotnet", "azure", "maps", "sdk", "for", "net", "location-based"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/azure-maps-search-dotnet`, fails to mention provenance, or does not use any copied source files at all.
