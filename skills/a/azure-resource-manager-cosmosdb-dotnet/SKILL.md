...
```text
Review @azure-resource-manager-cosmosdb-dotnet against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
