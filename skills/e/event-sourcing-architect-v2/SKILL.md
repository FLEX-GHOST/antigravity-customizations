---
name: event-sourcing-architect-v2
...
version: "0.0.1"
category: devops
tags: ["event-sourcing-architect-v2", "event-sourcing-architect", "expert", "event", "sourcing", "cqrs", "and", "event-driven"]
complexity: beginner
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/event-sourcing-architect`, fails to mention provenance, or does not use any copied source files at all.
