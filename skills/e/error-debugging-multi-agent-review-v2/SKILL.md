---
name: error-debugging-multi-agent-review-v2
...
tags: ["error-debugging-multi-agent-review-v2", "error-debugging-multi-agent-review", "working", "error", "debugging", "multi", "review", "development"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/error-debugging-multi-agent-review`, fails to mention provenance, or does not use any copied source files at all.
