...
tags: ["expo-cicd-workflows-v2", "expo-cicd-workflows", "helps", "understand", "and", "write", "eas", "yaml"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/expo-cicd-workflows`, fails to mention provenance, or does not use any copied source files at all.
