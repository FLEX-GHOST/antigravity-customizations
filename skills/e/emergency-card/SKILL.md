...
version: "0.0.1"
category: frontend
tags: ["emergency-card", "json", "frontend"]
complexity: advanced
risk: safe
...
```text
Review @emergency-card against metadata.json and ORIGIN.md, then explain which copied upstream files you would load first and why.
```
