...
version: "0.0.1"
category: frontend
tags: ["expo-tailwind-setup", "set", "tailwind", "css", "expo", "react-native-css", "and", "nativewind"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/expo-tailwind-setup`, fails to mention provenance, or does not use any copied source files at all.
