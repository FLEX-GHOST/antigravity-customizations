...
version: "0.0.1"
category: devops
tags: ["event-store-design", "design", "and", "implement", "event", "stores", "for", "event-sourced"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/event-store-design`, fails to mention provenance, or does not use any copied source files at all.
