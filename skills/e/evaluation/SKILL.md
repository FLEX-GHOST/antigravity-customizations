...
version: "0.0.1"
category: ai-agents
tags: ["evaluation", "build", "frameworks", "for", "systems", "use", "testing", "performance"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/evaluation`, fails to mention provenance, or does not use any copied source files at all.
