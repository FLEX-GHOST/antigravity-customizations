...
version: "0.0.1"
category: ai-agents
tags: ["explain-like-socrates-v2", "explain-like-socrates", "ai-agents"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/explain-like-socrates`, fails to mention provenance, or does not use any copied source files at all.
