...
version: "0.0.1"
category: frontend
tags: ["building-native-ui", "complete", "guide", "for", "building", "beautiful", "apps", "expo"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/building-native-ui`, fails to mention provenance, or does not use any copied source files at all.
