...
tags: ["bitbucket-automation", "automate", "bitbucket", "repositories", "pull", "requests", "branches", "issues"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/bitbucket-automation`, fails to mention provenance, or does not use any copied source files at all.
