...
tags: ["backend-security-coder", "expert", "secure", "backend", "coding", "practices", "specializing", "input"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/backend-security-coder`, fails to mention provenance, or does not use any copied source files at all.
