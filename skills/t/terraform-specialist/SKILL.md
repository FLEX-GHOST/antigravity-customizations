...
version: "0.0.1"
category: devops
tags: ["terraform-specialist", "expert", "terraform", "opentofu", "specialist", "mastering", "advanced", "iac"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/terraform-specialist`, fails to mention provenance, or does not use any copied source files at all.
