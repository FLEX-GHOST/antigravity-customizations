...
version: "0.0.1"
category: frontend
tags: ["threejs-skills", "create", "scenes", "interactive", "experiences", "and", "visual", "effects"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/threejs-skills`, fails to mention provenance, or does not use any copied source files at all.
