...
tags: ["tdd-workflow", "test-driven", "development", "principles", "red-green-refactor", "cycle"]
complexity: beginner
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/tdd-workflow`, fails to mention provenance, or does not use any copied source files at all.
