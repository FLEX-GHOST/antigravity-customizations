...
tags: ["threejs-fundamentals", "three", "scene", "setup", "cameras", "renderer", "object3d", "hierarchy"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/threejs-fundamentals`, fails to mention provenance, or does not use any copied source files at all.
