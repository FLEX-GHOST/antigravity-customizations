...
version: "0.0.1"
category: backend
tags: ["typescript", "trpc", "api", "fullstack", "nextjs", "react", "type-safety", "trpc-fullstack"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/trpc-fullstack`, fails to mention provenance, or does not use any copied source files at all.
