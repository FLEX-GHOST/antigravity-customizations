...
tags: ["threejs-interaction", "three", "interaction", "raycasting", "controls", "mouse", "touch", "input"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/threejs-interaction`, fails to mention provenance, or does not use any copied source files at all.
