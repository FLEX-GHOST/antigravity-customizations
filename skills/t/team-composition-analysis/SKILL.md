...
version: "0.0.1"
category: frontend
tags: ["team-composition-analysis", "design", "optimal", "team", "structures", "hiring", "plans", "compensation"]
complexity: advanced
risk: safe
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/team-composition-analysis`, fails to mention provenance, or does not use any copied source files at all.
