---
name: javascript-typescript-typescript-scaffold-v2
...
tags: ["javascript-typescript-typescript-scaffold-v2", "javascript-typescript-typescript-scaffold", "you", "are", "typescript", "project", "architecture", "expert"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/javascript-typescript-typescript-scaffold`, fails to mention provenance, or does not use any copied source files at all.
