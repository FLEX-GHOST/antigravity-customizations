...
version: "0.0.1"
category: devops
tags: ["java-pro-v2", "java-pro", "master", "java", "modern", "features", "like", "virtual"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/java-pro`, fails to mention provenance, or does not use any copied source files at all.
