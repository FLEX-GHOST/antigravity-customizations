...
tags: ["javascript-mastery-v2", "javascript-mastery", "essential", "javascript", "concepts", "every", "developer", "should"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills/skills/javascript-mastery`, fails to mention provenance, or does not use any copied source files at all.
