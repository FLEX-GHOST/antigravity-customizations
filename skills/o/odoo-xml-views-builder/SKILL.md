...
version: "0.0.1"
category: frontend
tags: ["odoo-xml-views-builder", "expert", "building", "odoo", "xml", "views", "form", "list"]
complexity: beginner
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/odoo-xml-views-builder`, fails to mention provenance, or does not use any copied source files at all.
