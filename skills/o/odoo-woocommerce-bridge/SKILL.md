...
version: "0.0.1"
category: backend
tags: ["odoo-woocommerce-bridge", "sync", "odoo", "woocommerce", "products", "inventory", "orders", "and"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/odoo-woocommerce-bridge`, fails to mention provenance, or does not use any copied source files at all.
