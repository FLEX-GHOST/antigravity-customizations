...
version: "0.0.1"
category: business
tags: ["odoo-backup-strategy", "complete", "odoo", "backup", "and", "restore", "strategy", "database"]
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-awesome-skills-claude/skills/odoo-backup-strategy`, fails to mention provenance, or does not use any copied source files at all.
