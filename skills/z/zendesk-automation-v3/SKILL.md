...
tags: ["zendesk-automation-v3", "zendesk-automation", "automate", "zendesk", "tasks", "via", "rube", "mcp"]
complexity: advanced
risk: caution
...
**Symptoms:** The result ignores the upstream workflow in `plugins/antigravity-bundle-revops-crm-automation/skills/zendesk-automation`, fails to mention provenance, or does not use any copied source files at all.
